...
class Server(models.Model):
    ...
    supplier = models.ForeignKey(Supplier, on_delete=models.SET_NULL, verbose_name="供应商", blank=True, null=True,
                                 max_length=12,
                                 help_text="供应商")
    idc = models.ForeignKey(Idc, on_delete=models.SET_NULL, verbose_name="所属IDC机房", max_length=16, null=True,
                            help_text="所属IDC机房")
    cabinet = models.ForeignKey(Cabinet, on_delete=models.SET_NULL, verbose_name="所属机柜", max_length=16, null=True,
                                help_text="所属机柜")
