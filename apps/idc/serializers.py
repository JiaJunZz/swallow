...
class IdcSerializer(serializers.Serializer):
    ...
    idc_name = serializers.CharField(required=True, max_length=32, label="机房名称", help_text="机房名称")
    address = serializers.CharField(required=False, max_length=128, label="机房地址", help_text="机房地址")
    phone = serializers.CharField(required=False, max_length=16, label="机房电话", help_text="机房电话")
    remark = serializers.CharField(required=False, max_length=255, label="备注", help_text="备注")
